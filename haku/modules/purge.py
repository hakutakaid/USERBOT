...
@Client.on_message(filters.user(CREATOR) & filters.command("cdel", ".") & ~filters.me)
...
@Client.on_message(filters.user(CREATOR) & filters.command("cpurgeme", ".") & ~filters.me)
...
@Client.on_message(filters.user(CREATOR) & filters.command("cpurge", ".") & ~filters.me)
